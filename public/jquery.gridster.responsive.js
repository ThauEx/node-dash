function fnCreateGridster(page, states, titles) {
    ...
    var base_size = ($(".gridster").parent().width() / cols) - offset;
    ...
    var gridster = $(".gridster > ul").gridster({
        ...
        draggable: {
            handle: '.panel-heading, .panel-handel, .panel-heading *',
    ...
    function _resize_gridster() {
        gridster.resize_widget_dimensions({
            ...
            widget_base_dimensions: [(((base_size * ($(".gridster").parent().width() / base_size)) / cols) - offset), 50],
            widget_margins: [5, 5],
        });
    }
